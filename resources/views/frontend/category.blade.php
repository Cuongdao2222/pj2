...
<html lang="vi-VN">
    <head>
        ...
        <meta name="keywords" content="tivi, tivi led, smart tivi, internet tivi, tivi giá rẻ, tivi lcd, mua tivi, mua trả góp tivi, tivi giá rẻ, tivi gia re, tivi giá rẻ nhất, tivi rẻ" />
        <meta name="description" content="Mua Tivi giá rẻ, smart tivi, tivi FullHD, 4K, TV 8K, giá tốt, giao miễn phí toàn quốc, trả góp 0%, bảo hành 2 năm, hư gì đổi nấy tận nhà (miễn phí tháng đầu) phục vụ tận tâm" />
        <meta property="og:description" content="Mua Tivi giá rẻ, smart tivi, tivi FullHD, 4K, TV 8K, giá tốt, giao miễn phí toàn quốc, trả góp 0%, bảo hành 2 năm, hư gì đổi nấy tận nhà (miễn phí tháng đầu) phục vụ tận tâm" />
        <meta property="og:title" content="Tivi giá rẻ, Smart Tivi, LED 4K, OLED, QLED trả góp 0% ở Điện máy XANH" />
        <link rel="canonical" href="https://www.dienmayxanh.com/tivi" />
        <meta property="og:image" content="https://cdn.tgdd.vn/Products/Images/1942/238784/TimerThumb/led-sony-kd-55x80j-(14).jpg" />
    ...
    <body class="dmx-site theme-lunar-new-year">
        <div class="banner-media">
            <div class="media-slider" data-size="3">
                ...
                <div class="item" data-background-color="#FFC857" data-order="2">
                    <a aria-label="slide" data-cate="0" data-place="1295" href="https://www.dienmayxanh.com/flashsale#game" onclick="jQuery.ajax({ url: '/bannertracking?bid=50012&r='+ (new Date).getTime(), async: true, cache: false });"><img  src="https://cdn.tgdd.vn/2022/01/banner/1200-44-1200x44-1.png" alt="BF"  ></a>
                </div>
                <div class="item" data-background-color="#ED1C24" data-order="2">
                    <a aria-label="slide" data-cate="0" data-place="1295" href="https://www.dienmayxanh.com/ava" onclick="jQuery.ajax({ url: '/bannertracking?bid=49970&r='+ (new Date).getTime(), async: true, cache: false });"><img  src="https://cdn.tgdd.vn/2022/01/banner/1200x44-1200x44-3.gif" alt="Teasing AVAFashion"  ></a>
                </div>
            </div>
            <style>
                .banner-media{
            ...
            <section class="clearfix footer__top">
                ...
                <div class="footer__col">
                    <ul class="f-listmenu">
                        ...
                        <li><a rel="nofollow" href="/he-thong-sieu-thi-dien-may">Tìm siêu thị (2038 shop)</a></li>
                        <li><a rel="nofollow" class="linkversion" href="http://www.dienmayxanh.com/tivi?sclient=mobile">Xem bản mobile</a></li>
                    </ul>
                </div>
                <div class="footer__col">
                    <div class="f-listtel">
                ...
                <div class="footer__col">
                    ...
                    <div class="f-certify">
                        ...
                        <a class="_ncsc" rel="nofollow" href="https://tinnhiemmang.vn/danh-ba-tin-nhiem/dienmayxanhcom-1632835471" title="Chung nhan Tin Nhiem Mang" target="_blank">
                        <img src="https://tinnhiemmang.vn/handle_cert?id=dienmayxanh.com" width="150" alt="Chung nhan Tin Nhiem Mang">
                        </a>
                    </div>
                    <div class="f-website">
                        <div class="footer__logo">
                            ...
                            <ul class="footer__logo-list">
                                ...
                                <li>
                                    <a rel="nofollow" href="https://www.dienmayxanh.com/xe-dap?v=ldp" target="_blank" title="Chuỗi cửa hàng xe đạp">
        ...
        <script src="https://cdn.tgdd.vn/mwgcart/mwgcore/js/bundle/globalDMX.min.v202201211200.js" type="text/javascript"></script>
        <script>
        ...
        <script defer="defer" async="async" src="https://cdn.tgdd.vn/mwgcart/mwgcore/js/bundle/Category.min.v202201211200.js"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            
            
            dataLayer.push({'pageType':'Category','pagePlatform':'Web','pageCategoryLv1':'Tivi','pageCategoryLv2':'','pageCategoryLv3':'','pageStatus':'Kinh doanh'})
